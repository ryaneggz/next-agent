...
const SystemMessageEditor = ({ isOpen, onClose, systemMessage, onSystemMessageChange }: SystemMessageEditorProps) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    setLocalSystemMessage(newMessage);
    onSystemMessageChange(newMessage);
  };
